	...
	<ul>
		...
		<li>
			<ul>
				...
				<li>out : JspWriter, JSP 출력 스트림 객체</li>
		...
		<li>Attribute를 저장 객체 : pageContext -> request -> session -> application<br>
			(EL 사용할 때 화살표 방향으로 저장된 애트리뷰트 값을 찾습니다.)</li>
		<li>※EL 에서 사용할 수 있는 객체는 jsp 내장 객체와는 다릅니다.※</li>
	</ul>
	<%
		// 현재 요청 처리하는 jsp 페이지의 Exception 객체를 pageContext.getException() 리턴
		// -> Exception 발생시 -
		// 오류 없으면 null
